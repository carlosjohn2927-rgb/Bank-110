...
<div class="grid two deposit-grid">
  ...
  <section class="panel deposit-capture">
    ...
    <form method="post" action="<?=site_url('deposits/create')?>" enctype="multipart/form-data" class="deposit-form" id="depositForm"><input type="hidden" name="<?=$this->security->get_csrf_token_name()?>" value="<?=$this->security->get_csrf_hash()?>">
      <label>Deposit to
