...
$route['admin/return'] = 'auth/return_to_admin';
...
$route['admin/customers/(:num)/edit'] = 'admin/customer_edit/$1';
$route['admin/customers/(:num)/login-as'] = 'admin/login_as/$1';
...
$route['admin/profile/password'] = 'admin/profile_password';
