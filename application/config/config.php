...
$config['encryption_key'] = getenv('VP_ENCRYPTION_KEY') ?: '';
...
$config['cookie_path'] = '/';
$config['cookie_secure'] = filter_var(getenv('VP_COOKIE_SECURE') !== FALSE ? getenv('VP_COOKIE_SECURE') : (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off'), FILTER_VALIDATE_BOOLEAN);
